                            ...
                            @foreach($alumnos as $alumno)
                                <tr>
                                    ...
                                    <td width="20%" style="text-align: center">
                                        <a type="button" class="btn btn-primary " href="{{url('/inscripciones_cendi/'.$alumno->id)}}">
                                            <i class="fa fa-user"> </i> Ver Inscripción
                                        </a>
                                        <a type="button" class="btn btn-success " href="{{url('/inscripciones_cendi/print/'.$alumno->id)}}">

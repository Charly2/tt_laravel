...
@section('content')
    ...
    @include('app.verificadocumentos._toptiles')
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        @foreach($validas as $valida)
                            <tr class="">
                                ...
                                <td>
                                    @if($itemactive == 1)
                                        <a href="{{url('/validadocumentos/valida/'.$valida->id)}}" class="btn btn-success btn-xs">Validar</a>
                                    @endif
                                    @if($itemactive == 2 || $itemactive == 3)
                                        <a href="{{url('/validadocumentos/ver/'.$valida->id)}}" class="btn btn-success btn-xs">Ver</a>
                                    @endif
                                </td>
